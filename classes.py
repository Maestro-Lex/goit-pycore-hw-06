...
class Record:
    ...
    def add_phone(self, phone: str):
        ...
        if self.phones: # Якщо список об'єктів запису вже містить номери
            ...
            for p in self.phones:
                values_list.append(p.value)
            # Якщо новий телефон ще відстуній, то додаємо новий об'єкт Phone
            if phone not in values_list:
                self.phones.append(Phone(phone))
            else:
                print(f"{self.name.value} already has {phone} among his phone numbers!")
    ...
    def remove_phone(self, phone: str):
        ...
        print(f"{self.name.value} has no {phone} among his phone numbers!")
    ...
    def edit_phone(self, old_phone: str, new_phone: str):
        ...
        for p in self.phones:
            if p.value == old_phone:
                p.value = new_phone
                return # прериваємо виконання методу при знайденному співпадінні
        print(f"{self.name.value} has no {old_phone} among his phone numbers!")
